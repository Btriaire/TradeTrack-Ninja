...
UNIVERSE = [
    # ── CAC 40 ──────────────────────────────────────────────────────────────
    {"symbol": "MC.PA",   "name": "LVMH",             "index": "CAC 40",   "country": "🇫🇷", "sector": "Luxe & Mode"},
    {"symbol": "AIR.PA",  "name": "Airbus",            "index": "CAC 40",   "country": "🇫🇷", "sector": "Aérospatiale"},
    {"symbol": "TTE.PA",  "name": "TotalEnergies",     "index": "CAC 40",   "country": "🇫🇷", "sector": "Énergie"},
    {"symbol": "BNP.PA",  "name": "BNP Paribas",       "index": "CAC 40",   "country": "🇫🇷", "sector": "Finance"},
    {"symbol": "SAN.PA",  "name": "Sanofi",            "index": "CAC 40",   "country": "🇫🇷", "sector": "Santé"},
    {"symbol": "OR.PA",   "name": "L'Oréal",           "index": "CAC 40",   "country": "🇫🇷", "sector": "Consommation"},
    {"symbol": "RI.PA",   "name": "Pernod Ricard",     "index": "CAC 40",   "country": "🇫🇷", "sector": "Consommation"},
    {"symbol": "SU.PA",   "name": "Schneider Electric","index": "CAC 40",   "country": "🇫🇷", "sector": "Industrie"},
    {"symbol": "KER.PA",  "name": "Kering",            "index": "CAC 40",   "country": "🇫🇷", "sector": "Luxe & Mode"},
    {"symbol": "DSY.PA",  "name": "Dassault Systèmes", "index": "CAC 40",   "country": "🇫🇷", "sector": "Technologie"},
    {"symbol": "CAP.PA",  "name": "Capgemini",         "index": "CAC 40",   "country": "🇫🇷", "sector": "Technologie"},
    {"symbol": "STM.PA",  "name": "STMicroelectronics","index": "CAC 40",   "country": "🇫🇷", "sector": "Technologie"},
    {"symbol": "RMS.PA",  "name": "Hermès",            "index": "CAC 40",   "country": "🇫🇷", "sector": "Luxe & Mode"},
    {"symbol": "ACA.PA",  "name": "Crédit Agricole",   "index": "CAC 40",   "country": "🇫🇷", "sector": "Finance"},
    {"symbol": "SAF.PA",  "name": "Safran",            "index": "CAC 40",   "country": "🇫🇷", "sector": "Aérospatiale"},
    {"symbol": "GLE.PA",  "name": "Société Générale",  "index": "CAC 40",   "country": "🇫🇷", "sector": "Finance"},
    {"symbol": "RNO.PA",  "name": "Renault",           "index": "CAC 40",   "country": "🇫🇷", "sector": "Automobile"},
    {"symbol": "ENGI.PA", "name": "Engie",             "index": "CAC 40",   "country": "🇫🇷", "sector": "Énergie"},
    {"symbol": "AI.PA",   "name": "Air Liquide",       "index": "CAC 40",   "country": "🇫🇷", "sector": "Matériaux"},
    {"symbol": "DG.PA",   "name": "Vinci",             "index": "CAC 40",   "country": "🇫🇷", "sector": "Industrie"},
    # ── DAX ─────────────────────────────────────────────────────────────────
    {"symbol": "SAP.DE",  "name": "SAP",               "index": "DAX",      "country": "🇩🇪", "sector": "Technologie"},
    {"symbol": "SIE.DE",  "name": "Siemens",           "index": "DAX",      "country": "🇩🇪", "sector": "Industrie"},
    {"symbol": "ALV.DE",  "name": "Allianz",           "index": "DAX",      "country": "🇩🇪", "sector": "Finance"},
    {"symbol": "BMW.DE",  "name": "BMW",               "index": "DAX",      "country": "🇩🇪", "sector": "Automobile"},
    {"symbol": "BAYN.DE", "name": "Bayer",             "index": "DAX",      "country": "🇩🇪", "sector": "Santé"},
    {"symbol": "BAS.DE",  "name": "BASF",              "index": "DAX",      "country": "🇩🇪", "sector": "Matériaux"},
    {"symbol": "ADS.DE",  "name": "Adidas",            "index": "DAX",      "country": "🇩🇪", "sector": "Consommation"},
    # ── S&P 500 / NASDAQ ────────────────────────────────────────────────────
    {"symbol": "AAPL",    "name": "Apple",             "index": "NASDAQ",   "country": "🇺🇸", "sector": "Technologie"},
    {"symbol": "MSFT",    "name": "Microsoft",         "index": "NASDAQ",   "country": "🇺🇸", "sector": "Technologie"},
    {"symbol": "NVDA",    "name": "NVIDIA",            "index": "NASDAQ",   "country": "🇺🇸", "sector": "Technologie"},
    {"symbol": "AMZN",    "name": "Amazon",            "index": "NASDAQ",   "country": "🇺🇸", "sector": "Technologie"},
    {"symbol": "META",    "name": "Meta",              "index": "NASDAQ",   "country": "🇺🇸", "sector": "Technologie"},
    {"symbol": "TSLA",    "name": "Tesla",             "index": "NASDAQ",   "country": "🇺🇸", "sector": "Automobile"},
    {"symbol": "JPM",     "name": "JPMorgan",          "index": "S&P 500",  "country": "🇺🇸", "sector": "Finance"},
    {"symbol": "JNJ",     "name": "Johnson & Johnson", "index": "S&P 500",  "country": "🇺🇸", "sector": "Santé"},
    # ── FTSE 100 ────────────────────────────────────────────────────────────
    {"symbol": "SHEL.L",  "name": "Shell",             "index": "FTSE 100", "country": "🇬🇧", "sector": "Énergie"},
    {"symbol": "AZN.L",   "name": "AstraZeneca",       "index": "FTSE 100", "country": "🇬🇧", "sector": "Santé"},
    {"symbol": "HSBA.L",  "name": "HSBC",              "index": "FTSE 100", "country": "🇬🇧", "sector": "Finance"},
    # ── Euronext Amsterdam ──────────────────────────────────────────────────
    {"symbol": "ASML.AS", "name": "ASML",              "index": "AEX",      "country": "🇳🇱", "sector": "Technologie"},
